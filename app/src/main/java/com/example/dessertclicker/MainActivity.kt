...
private fun DessertClickerApp(
    dessertClickerViewModel: DessertClickerViewModel = viewModel() // my ViewModel
) {
    // my uiState accessed from the viewModel
    // collectAsState fetches the whole current uiState object
    ...
    Scaffold(
        ...
        DessertClickerScreen(
            revenue = dessertClickerState.revenue,
            dessertsSold = dessertClickerState.dessertsSold,
            dessertImageId = dessertClickerState.currentDessertImageId,
            // passing a reference to the function
            // the lambda way would have called the function immediately
            // which we don't want to do right way as it is called down the road in the component itself
